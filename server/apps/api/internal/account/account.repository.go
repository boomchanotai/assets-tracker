...
type Repository interface {
	...
	UpdateAccount(ctx context.Context, userID uuid.UUID, id uuid.UUID, input entity.AccountInput) (*entity.Account, error)
...
func (r *repository) UpdateAccount(ctx context.Context, userID uuid.UUID, id uuid.UUID, input entity.AccountInput) (*entity.Account, error) {
	var a model.Account
...
func (r *repository) DeleteAccount(ctx context.Context, userID uuid.UUID, id uuid.UUID) error {
	if err := r.db.Where("id = ? AND user_id = ?", id, userID).Delete(&model.Account{}).Error; err != nil {
